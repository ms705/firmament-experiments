...
def plot_cdf(plot_file_name, cdf_vals, label_axis, labels, log_scale=False,
    ...
    if log_scale:
        ...
        plt.xticks(range(0, max_cdf_val, 10000000),
                   [str(x / 1000 / 1000) for x in range(0, max_cdf_val, 10000000)])
    plt.ylim(0, 1.0)
...
def main(argv):
    ...
    plot_cdf('scheduling_runtimes_cdf', sched_runtimes, "Duration [sec]",
             sched_trace_labels, log_scale=True, bin_width=1000, unit='sec')
