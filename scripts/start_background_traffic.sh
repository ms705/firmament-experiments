...
ssh srguser@caelum-212.cl.cam.ac.uk 'screen -d -m iperf -c 10.0.0.23 -i 2 -t 10000'
ssh srguser@caelum-213.cl.cam.ac.uk 'screen -d -m iperf -c 10.0.0.23 -i 2 -t 10000'
# # 310
