...
ssh srguser@caelum-206.cl.cam.ac.uk 'screen -d -m iperf -s'
...
ssh srguser@caelum-308.cl.cam.ac.uk 'screen -d -m iperf -c 10.0.0.38 -i 2 -t 10000'
ssh srguser@caelum-309.cl.cam.ac.uk 'screen -d -m iperf -c 10.0.0.38 -i 2 -t 10000'
# 401
...
ssh srguser@caelum-404.cl.cam.ac.uk 'screen -d -m iperf -c 10.0.0.48 -i 2 -t 10000'
ssh srguser@caelum-405.cl.cam.ac.uk 'screen -d -m iperf -c 10.0.0.48 -i 2 -t 10000'
# 206
ssh srguser@caelum-207.cl.cam.ac.uk 'screen -d -m iperf -c 10.0.0.25 -i 2 -t 10000'
ssh srguser@caelum-208.cl.cam.ac.uk 'screen -d -m iperf -c 10.0.0.25 -i 2 -t 10000'
ssh srguser@caelum-209.cl.cam.ac.uk 'screen -d -m iperf -c 10.0.0.25 -i 2 -t 10000'
ssh srguser@caelum-212.cl.cam.ac.uk 'screen -d -m iperf -c 10.0.0.25 -i 2 -t 10000'
# # 310
...
# ssh srguser@caelum-313.cl.cam.ac.uk 'screen -d -m iperf -c 10.0.0.43 -i 2 -t 10000'
# ssh srguser@caelum-314.cl.cam.ac.uk 'screen -d -m iperf -c 10.0.0.43 -i 2 -t 10000'
...
ssh srguser@caelum-108.cl.cam.ac.uk 'screen -d -m ab -n 10000000000 -c 20 http://10.0.0.14:8084/'
# 410
